# -*- coding: utf-8 -*-
"""
Created on Tue Feb 21 14:02:56 2017

@author: chyam

"""
# Reference: https://github.com/hizhangp/caltech-pedestrian-converter/blob/master/converter.py
    ...
    for frame_id, obj in enumerate(objLists):
        if len(obj) > 0:
            for id, pos, occl, lock, posv in zip(obj['id'][0], obj['pos'][0],
                ...
                datum = dict(list(zip(keys, [id, pos, occl, lock, posv])))
